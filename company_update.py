...
# 1. โหลดข้อมูล (กรุณาเปลี่ยนชื่อไฟล์ให้ตรงกับไฟล์ในเครื่องของคุณ)
# สมมติว่ามีไฟล์ mt_comp.csv และ sp_company.csv
df_mt = pd.read_csv('mt_comp.csv')
df_sp = pd.read_csv('sp_company.csv')
...
df_sp.to_csv('sp_company_updated.csv', index=False, encoding='utf-8-sig')
print("สร้างไฟล์ sp_company_updated.csv เรียบร้อยแล้ว!")